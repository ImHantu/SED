...
\begin{itemize}
\item lu.uni.lassy.excalibur.examples.icrash.concepts.messir.MyPackageEnvironment.msr.suMessageToMedia 
\end{itemize}


\subsection[Undocumented Use Cases - Subfunction Level]{Undocumented Subfunction Level Use Cases}
\begin{itemize}
\item Media2.msr.sfGetCrisisInfo 
\end{itemize}
...
\begin{itemize}
\item icrash.environment.actEditor 
\end{itemize}
